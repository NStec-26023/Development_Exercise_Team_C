...
INSERT INTO employee_account (acc_id, name, password, emp_id) VALUES (nextval('seq_accno'), 'fullness', '3ed5b3d711ca7f9d801758180e79c3bf637e6529fefca8c44e3987813ca82758', 1001);
INSERT INTO employee_account (acc_id, name, password, emp_id) VALUES (nextval('seq_accno'), 'm.sato', 'P@a6e0110108a92b4207ef5ce36e51330ab1493513a37214252c8ab8561800ac81', 1002);
INSERT INTO employee_account (acc_id, name, password, emp_id) VALUES (nextval('seq_accno'), 'k.suzuki', 'P@ssw0rd1003', 1003);
INSERT INTO employee_account (acc_id, name, password, emp_id) VALUES (nextval('seq_accno'), 'k.suzuki', 'P@ssw0rd1003', 1003);
...
INSERT INTO product (pro_id, name, price, image_url, cat_id, delete_flg) VALUES (nextval('seq_prono'), 'USB有線キーボード', '1400', 'keybord2.jpg', '102', '0');
...
INSERT INTO product (pro_id, name, price, image_url, cat_id, delete_flg) VALUES (nextval('seq_prono'), '有線光化学式マウス', '500', 'mouse_b.jpg', '102', '0');
...
INSERT INTO order_status (sta_id, name) VALUES (nextval('seq_stano'), '完了');
INSERT INTO order_status (sta_id, name) VALUES (nextval('seq_stano'), '配送中');
INSERT INTO order_status (sta_id, name) VALUES (nextval('seq_stano'), 'キャンセル');
INSERT INTO order_status (sta_id, name) VALUES (nextval('seq_stano'), '注文済み');


/* customerテーブルにデータを挿入 */
INSERT INTO customer (cus_id, name, address1, address2, phone_number, mail_address, username, password, created_at) VALUES (nextval('seq_cusno'), '山田太郎', '東京都渋谷区', '1-11-11', '090-1234-5678', 'taro@example.com', 'taro123', 'Pass_yamada1', '2024-04-12');
INSERT INTO customer (cus_id, name, address1, address2, phone_number, mail_address, username, password, created_at) VALUES (nextval('seq_cusno'), '田中健二', '東京都新宿区', 'テストビル101', '080-1234-5678', 't.kenji@example.com', 'testuser(テスト顧客)', 'Pass_tanaka2', '2024-05-08');


/* payment_methodテーブルにデータを挿入 */
INSERT INTO payment_method (pay_id, name) VALUES (nextval('seq_payno'), 'クレジットカード');
INSERT INTO payment_method (pay_id, name) VALUES (nextval('seq_payno'), '口座振替');


/* ordersテーブルにデータを挿入 */
INSERT INTO orders (ord_id, order_date, amount_total, cus_id, sta_id, pay_id) VALUES (nextval('seq_ordno'), '2024-04-09 06:30:00', '320', '10001', '101', '001');
INSERT INTO orders (ord_id, order_date, amount_total, cus_id, sta_id, pay_id) VALUES (nextval('seq_ordno'), '2024-05-12 15:30:00', '100', '10002', '104', '002');


/* orders_detailテーブルにデータを挿入 */
INSERT INTO orders_detail (det_id, ord_id, pro_id, counts) VALUES (nextval('seq_detno'), '2', '001', '1');
INSERT INTO orders_detail (det_id, ord_id, pro_id, counts) VALUES (nextval('seq_detno'), '1', '005', '2');
