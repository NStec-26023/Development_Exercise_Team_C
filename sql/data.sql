...
INSERT INTO product (pro_id, name, price, image_url, cat_id, delete_flg) VALUES (nextval('seq_prono'), '水性ボールペン(青)', '120', 'blue_pen_w.jpeg', '101', '0');
...
/* customerテーブルにデータを挿入 */
INSERT INTO customer (cus_id, name, address1, address2, phone_number, mail_address, username, password, register_date) VALUES (nextval('seq_cusno'), '山田太郎', '東京都渋谷区', '1-11-11', '090-1234-5678', 'taro@example.com', 'taro123', 'Pass_yamada1', '2024-04-12');
INSERT INTO customer (cus_id, name, address1, address2, phone_number, mail_address, username, password, register_date) VALUES (nextval('seq_cusno'), '田中健二', '東京都新宿区', 'テストビル101', '080-1234-5678', 't.kenji@example.com', 'testuser(テスト顧客)', 'Pass_tanaka2', '2024-05-08');
